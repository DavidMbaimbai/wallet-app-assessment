...
public class AccountUtils {
    ...
    public static final String ACCOUNT_FOUND_SUCCESS = "Customer Account Found";
    public static final String ACCOUNT_CREDITED_SUCCESS = "005";
    public static final String ACCOUNT_CREDITED_SUCCESS_MESSAGE = "Customer Account was credited successfully";
